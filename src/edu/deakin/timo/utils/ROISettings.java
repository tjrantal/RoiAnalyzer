...
public class ROISettings extends JFrame {
	...
	public final String[] keys = {"Sub-region Rows","Sub-region Columns","Root Directory","Results Sub-directory","Roi results directory","Visualize Sub-regions [0 = off]"};
	private final String[] defaults = {"5","5","c:/Output","IVD","ROIs","0"};
