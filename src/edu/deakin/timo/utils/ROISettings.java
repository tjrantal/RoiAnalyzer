...
public class ROISettings extends JFrame {
	...
	public final String[] keys = {"Sub-region Rows","Sub-region Columns","Root Directory","Results Sub-directory","Roi results directory","Visualize Sub-regions [<1 off]","ROI to read","Stack path","Rotation [0 all pix, 1 top row, 4 no rotation]","Erode ROIs"};
	private final String[] defaults = {"1","5","c:/Output","IVD","ROIs","0","c:/Output","C:/timo/research/BelavyQuittner2015/stacks","1","0"};
