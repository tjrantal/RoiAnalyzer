...
public class ROISettings extends JFrame {
	...
	public final String[] keys = {"Sub-region Rows","Sub-region Columns","Root Directory","Results Sub-directory","Roi results directory","Visualize Sub-regions [<1 off]","ROI to read","Stack path","Rotation [0 all pix, 1 top row]","Erode ROIs"};
